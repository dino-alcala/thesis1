...
<html>
    ...
    <body>
        ...
        <div class="row" id="body-row">
            ...
            <div class="col py-3">
                <form action="approveFF2" method="post">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <table style="width:100%">
                                    ...
                                    <tr>
                                        <td>Step 1</td>
                                        <td><%=FF.getJayRemarks()%></td>
                                    </tr>
                                    <tr>
                                        <td>Step 2</td>
                                        <td style="padding:0px"><textarea id="remarks2" rows="3" cols="95" style="margin-bottom:-5px;" name="remarks1"><%=FF.getCarmelRemarks()%></textarea></td>
                                    </tr>
                                    <tr>
                                        <td>Step 3</td>
