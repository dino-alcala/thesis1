...
<html>
    <head>
        ...
        <title>SE Programs for Edit List</title>
        ...
        <script type="text/javascript">
            <%
                if (request.getAttribute("editProgram") != null) {

            %>
            $("document").ready(function () {

                alert("<%=request.getAttribute("editProgram")%>");
            });
    ...
    <body>
        ...
        <div class="row" id="body-row">
            ...
            <div class="col py-3">
                <form action="viewSE9" method="post">

                    <%
                        ArrayList<SE> proposals = new ArrayList();
                        proposals = UserDAO.retrieveSEProposalsForEdit();
                    %>
                    <!--- table -->
