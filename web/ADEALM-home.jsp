<%-- 
    Document   : ADEALM-home
    Created on : 06 18, 18, 7:11:33 PM
    Author     : Karl Madrid
--%>
...
<div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
        <li class="nav-item dropdown d-sm-block d-md-none">
            <a class="nav-link" href="ADEALM-home.jsp" id="smallerscreenmenu">
                Home
            </a>
            ...
            <a class="nav-link" href="MULTIPLE-ffEvaluationFormsList.jsp" id="smallerscreenmenu">
                Evaluation Forms
            </a>
        </li>
    </ul>
        ...
        <form action="viewProposalsProgress" method="post">
            ...
            <div class="container panels">
                ...
                <table class="table ">
                    ...
                    <th onclick="sortTable(1)">Program Name</th>
                    <th onclick="sortTable(2)">Program Head</th>
                    <th                             onclick="sor                                tTable(3)">Funded by</th>
                    <th                             onclick="sortTab                            le(4)">Status</t                            h>
                    <th                             onclick="sortTab                            le(5)">Department</th>
                                             <th></th>
                            </tr>
                        </thead>
                        <tbody id="myTable">
