                ...
                <div class="form-style-5">
                    <form action = "addSE" method="post"> 
                        ...
                        <fieldset>
                            ...
                            <input id="inputText" value="<%= UserDAO.getFirstName(Integer.parseInt(session.getAttribute("userID").toString()))%> <%= UserDAO.getLastName(Integer.parseInt(session.getAttribute("userID").toString()))%>" type = "text" name ="programhead" required>
                            <br><br><br><br>
                        </fieldset>
