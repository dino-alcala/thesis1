<%-- 
    Document   : MULTIPLE-programReportsList
    Created on : 06 18, 18, 7:52:45 PM
    Author     : Karl Madrid
--%>
...
<%if (session.getAttribute("unit").toString().equals("Center For Social Concern and Action (COSCA)")) {
            ...
            <!-- MAIN -->
            <div class="col py-3">
                <form action="viewSEreport" method="post">
                    <!--- table -->
                    <div class="container-fluid panels">
                        ...
                        <table id="example" class="table table-striped table-bordered">
                            ...
                            <tbody id="myTable">
                                <%
                                    ArrayList<SEreport> s = new ArrayList();
                                    s = UserDAO.retrieveSEReport();

                                    for (int i = 0; i < s.size(); i++) {
                                %>
                                <tr>
                                    <td><%=s.get(i).getProjectTitle()%></td>        
                                    <td><%=s.get(i).getUnit()%></td>
                                    <td><%=s.get(i).getProgramhead()%></td>
                                    <td><%=s.get(i).getDate()%></td>
                                    <td><button type="submit" name="viewReport<%=i%>" value="<%=s.get(i).getSeproposalID()%>" class="btn btn-info">View</button></td>
                                </tr>
                                <%
                                    }
                                %>
