...
<html>
    ...
    <body>
        ...
        <div class="row" id="body-row">
            ...
            <!-- MAIN -->
            <div class="col py-3">
                <form action="approveSEEdit" method="post">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <center>
                                            <b>Reason for Edit of SE Program:</b><br>
                                            <%=SE.getReasonforedit()%>
                                        </center>
                                    </div>
                                </div>
                                ...
                                <center>
                                    <button onclick="return window.confirm('Approve Request for Edit?')" class="btn-success" name="edit" value="<%=SE.getId()%>">Approve Request for Edit</button>
                                </center>
                            </div>
