                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <table style="width:100%">
                                    ...
                                    <tr>
                                        <td>External Affairs/SE Director</td>
                                        <td style="padding:0px"><%if (SE.getExternaldirectorRemarks() != null) {%><%=SE.getExternaldirectorRemarks()%><%}%></td>
                                    </tr>
                                    <tr>
                                        <td>Dean/VP/VC</td>
                                        <td style="padding:0px"><textarea id="remarks1" rows="3" cols="95" style="margin-bottom:-5px;" name="remarks1"><%if (SE.getDeanRemarks() != null) {%><%=SE.getDeanRemarks()%><%}%></textarea></td>
                                    </tr>
                                </table>
                                <br/>
