<%-- 
    Document   : MULTIPLE-ffReportsList
    Created on : 07 31, 18, 3:47:52 PM
    Author     : Karl Madrid
--%>
    ...
    <body>
        ...
        <div class="row" id="body-row">
            ...
            <div id="sidebar-container" class="sidebar-expanded d-none d-md-block">
                ...
                <%
                    if (session.getAttribute("unit").equals("College of Computer Studies (CCS)")) {
                %>
            ...
            <!-- MAIN -->
            <div class="col py-3">
                <form action="viewFFreport" method="post">
                    <!--- table -->
                    <div class="container-fluid panels">
                        <div class="btn-group btn-group-justified">
                            <a type="button" class="btn btn-primary" id="seButton" href="MULTIPLE-seReportsList.jsp">Social Engagement</a>
                        ...
                        <table id="example" class="table table-striped table-bordered">
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th onclick="sortTable(2)">Project Head</th>
                            ...
                            <tbody id="myTable">
                                <%
                                    ArrayList<FFreport> f = new ArrayList();
                                    f = UserDAO.retrieveFFReport();

                                    for (int i = 0; i < f.size(); i++) {
                                %>
                                <tr>
                                    <td><%=f.get(i).getProjectTitle()%></td>        
                                    <td><%=f.get(i).getUnit()%></td>
                                    <td><%=f.get(i).getProgramHead()%></td>
                                    <td><%=f.get(i).getDate()%></td>
                                    <td><button type="submit" name="viewReport<%=i%>" value="<%=f.get(i).getFfproposalID()%>" class="btn btn-info">View</button></td>
                                </tr>
