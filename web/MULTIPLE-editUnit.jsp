        ...
        <div class="row" id="body-row">
            ...
            <div id="sidebar-container" class="sidebar-expanded d-none d-md-block">
                <ul class="list-group sticky-top sticky-offset">
                    <!-- Menu with submenu -->
                    <a href="OVPLM-home.html" class="list-group-item list-group-item-action flex-column align-items-start" id="sidebarCategory">
                    ...
                    <div id="submenuProposals" class="collapse sidebar-submenu">
                        ...
                        <a href="MULTIPLE-socialEngagementProgramsList.html" class="list-group-item list-group-item-action" id="subMenuCategoryBox">
                            <span class="menu-collapsed" id="subMenuCategory">SE Programs</span>
                        </a>
                        <a href="MULTIPLE-faithFormationProgramsList.html" class="list-group-item list-group-item-action"  id="subMenuCategoryBox">
                            <span class="menu-collapsed" id="subMenuCategory">FF Programs</span>
                        </a>
                    </div>
                    <a href="#submenuUnits" data-toggle="collapse" aria-expanded="false" class="list-group-item list-group-item-action flex-column align-items-start" id="sidebarCategoryActive">
                        <div class="d-flex w-100 justify-content-start align-items-center">
                    ...
                    <div id="submenuUnits" class="collapse sidebar-submenu">
                        <a href="OVPLM-addUnit.html" class="list-group-item list-group-item-action" id="subMenuCategoryBox">
                            <span class="menu-collapsed" id="subMenuCategory">Add Unit</span>
                        </a>
                        <a href="MULTIPLE-unitsList.html" class="list-group-item list-group-item-action"  id="sidebarCategoryActive">
                            <span class="menu-collapsed" id="sidebarCategoryActive">Units</span>
                        </a>
                    </div>
                    ...
                    <div id="submenuCommunity" class="collapse sidebar-submenu">
                        <a href="MULTIPLE-addCommunity.html" class="list-group-item list-group-item-action" id="subMenuCategoryBox">
                            <span class="menu-collapsed" id="subMenuCategory">Add Community</span>
                        </a>
                        <a href="MULTIPLE-communityList.html" class="list-group-item list-group-item-action"  id="subMenuCategoryBox">
                    ...
                    <div id="submenuReports" class="collapse sidebar-submenu">
                        ...
                        <a href="MULTIPLE-viewProgramReport.html" class="list-group-item list-group-item-action"  id="subMenuCategoryBox">
                    ...
                    <a href="MULTIPLE-evaluationFormsList.html" class="list-group-item list-group-item-action flex-column align-items-start" id="sidebarCategory">
                        <div class="d-flex w-100 justify-content-start align-items-center">
