...
<html>
    <head>
        ...
        <title>Request SE Proposal Edit</title>
    ...
    <body>
        ...
        <div class="row" id="body-row">
            ...
            <!-- MAIN -->
            <div class="col py-3">
                <form action="requestSEEdit" method="post">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4>Edit SE Program</h4>
                                    </div>
                                    <div class="card-body">
                                        <center>
                                            <b>Reason for Edit of SE Program - <%=UserDAO.getProgramName(SE.getId())%></b><br>
                                ...
                                <center>
                                    <button onclick="return window.confirm('Edit Program?')" class="btn-success" name="edit" value="<%=SE.getId()%>">Submit</button>
                                </center>
                            </div>
