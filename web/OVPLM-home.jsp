                ...
                <div class="container-fluid panels">
                    ...
                    <table class="table table-bordered">
                        ...
                        <td><%if(z!=0){%><b><%=kra.getGoals().get(y).getMeasures().get(z).getMeasure()%></b> - <%=kra.getGoals().get(y).getMeasures().get(z).getDescription()%><%}%>
                            ...
                            <%if(z==0){%><% if(percent <= 33){ %><td class="accomplishmentRed"><%} else if( percent <= 66){%><td class="accomplishmentYellow"><%} else if(percent <= 100){%><td class="accomplishmentGreen"><%} else {%><td><%}%><%=percentage.format(percent)%>%</td><%}%>
                            <%if(z!=0){%><% if(percent <= 33){ %><td class="accomplishmentRed"><%} else if( percent <= 66){%><td class="accomplishmentYellow"><%} else if(percent <= 100){%><td class="accomplishmentGreen"><%} else {%><td><%}%><%=percentage.format(percent)%>%</td><%}%>
