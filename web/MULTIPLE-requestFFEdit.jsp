...
<html>
    <head>
        ...
        <title>Request FF Proposal Edit</title>
    ...
    <body>
        ...
        <div class="row" id="body-row">
            ...
            <!-- MAIN -->
            <div class="col py-3">
                <form action="requestFFEdit" method="post">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4>Edit FF Program - <%=UserDAO.getProjectName(FF.getId())%></h4>
                                    </div>
                                    <div class="card-body">
                                        <center>
                                            <b>Reason for Edit of FF Program</b><br>
                                ...
                                <center>
                                    <button onclick="return window.confirm('Edit Program?')" class="btn-success" name="edit" value="<%=FF.getId()%>">Submit</button>
                                </center>
                            </div>
                        </div>
                    </div>
