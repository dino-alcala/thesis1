            ...
            <div id="sidebar-container" class="sidebar-expanded d-none d-md-block">
                <ul class="list-group sticky-top sticky-offset">
                    ...
                    <div id="submenuProposals" class="collapse sidebar-submenu">
                        <a href="MULTIPLE-createSEChecklist.jsp" class="list-group-item list-group-item-action"  id="subMenuCategoryBox">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <table style="width:100%">
                                    ...
                                    <tr>
                                        <td>Step 1</td>
                                        <td><%=SE.getJayRemarks()%></td>
                                    </tr>
                                    <tr>
                                        <td>Step 2</td>
                                        <td style="padding:0px"><textarea id="remarks2" rows="3" cols="95" style="margin-bottom:-5px;" name="remarks1"><%=SE.getCarmelRemarks()%></textarea></td>
                                    </tr>
                                    <tr>
                                        <td>Step 3</td>
                                ...
                                <br/>
                                <center><button class='btn-info'>Edit Target KRA</button></center><br>
