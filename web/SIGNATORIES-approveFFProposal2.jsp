                            ...
                            <div class="col-lg-12">
                                ...
                                <table style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding:0px"><textarea id="remarks1" rows="3" cols="95" style="margin-bottom:-5px;" name="remarks1"><%if (FF.getVplmRemarks() != null) {%><%=FF.getVplmRemarks()%><%}%></textarea></td>
                                    </tr>
                                </table>
                                <br/>
