<%-- 
    Document   : MULTIPLE-faithFormationProgramsList
    Created on : 06 18, 18, 7:47:50 PM
    Author     : Karl Madrid
--%>
...
<html>
    <head>
        ...
        <title>Faith Formation Programs List</title>
        ...
        <script type="text/javascript">
            <%
                if (request.getAttribute("FFreport") != null) {

            %>
            $("document").ready(function () {

                alert("<%=request.getAttribute("FFreport")%>");
            });
    ...
    <body>
        ...
        <div class="row" id="body-row">
            ...
            <div id="sidebar-container" class="sidebar-expanded d-none d-md-block">
                ...
                <%
                    if (session.getAttribute("unit").equals("Chairperson / Director") || session.getAttribute("unit").equals("Vice President for Lasallian Mission") || session.getAttribute("unit").equals("Dean / Unit Head") || session.getAttribute("unit").equals("Assistant Dean for Lasallian Mission / Assistant Unit Head")) {
                %>
            ...
            <!-- MAIN -->
            <div class="col py-3">
                <form action="viewFF4" method="post">

                    <%
                        ArrayList<FF> my = new ArrayList();
                        my = UserDAO.retrieveFFProposalByCompletedOwner(Integer.parseInt(session.getAttribute("userID").toString()));
                    %>
                    <!--- table -->
                    <div class="container-fluid panels">
                        ...
                        <table id="example" class="table table-striped table-bordered" style="width:100%">    
                            ...
                            <tbody id="myTable">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <%
                                            if (UserDAO.hasFFReport(my.get(i).getId())) {
                        ...
                        <%
                            ...
                            others = UserDAO.retrieveFFProposalByCompleted(Integer.parseInt(session.getAttribute("userID").toString()));
                        %>
                        ...
                        <table id="example2" class="table table-striped table-bordered" style="width:100%">    
                            ...
                            <tbody id="myTable">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <%
                                            if (UserDAO.hasFFReport(others.get(i).getId())) {
