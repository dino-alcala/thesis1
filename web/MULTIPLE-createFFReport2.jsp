<%-- 
    Document   : MULTIPLE-createFFReport2
    Created on : 07 10, 18, 7:29:25 PM
    Author     : Karl Madrid
--%>
    ...
    <head>
        ...
        <script type='text/javascript'>
            ...
            function addRow3() {
                ...
                var cell4 = row.insertCell(3);
                var cell5 = row.insertCell(4);
                cell1.innerHTML = '<td><textarea rows = "2" cols = "20%" name="item"></textarea></td>';
                cell2.innerHTML = '<td><textarea rows = "2" cols = "20%" name="approved"></textarea></td>';
                cell3.innerHTML = '<td><textarea rows = "2" cols = "20%" name="expended"></textarea></td>';
                cell4.innerHTML = '<td><textarea rows = "2" cols = "20%" name="variance"></textarea></td>';
                cell5.innerHTML = '<td><textarea rows = "2" cols = "20%" name="reason"></textarea></td>';
