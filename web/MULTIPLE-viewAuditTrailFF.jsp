                        ...
                        <div class="col-lg-12">
                            ...
                            <table style="width:100%">
                                ...
                                <tr>
                                    ...
                                    <td><%if (FF.getChairpersonRemarks() != null) {%><%=FF.getChairpersonRemarks()%><%if (FF.getApprove2()==1){%><br><b><font color = "green"> Approved:</font></b> <%} else if(FF.getRevise2()==1) {%><br><b><font color = "orange">Marked for revision:</font></b><%} else if(FF.getReject2()==1) {%><br><b><font color = "red">Rejected:</font></b><%}%> <%=FF.getChairpersondatetime()%><%}%> <%if (FF.getUnitheadremarks() != null) {%><%=FF.getUnitheadremarks()%><%if (FF.getApprove2()==1){%><b><font color = "green"> Approved:</font></b> <%} else if(FF.getRevise2()==1) {%> <b><font color = "orange">Revised:</font></b><%} else if(FF.getReject2()==1) {%> <b><font color = "red">Rejected:</font></b><%}%> <%=FF.getUnitheaddatetime()%><%}%></td>
                                </tr>
                                <tr>
                                    <td>Dean/Director</td>
                                    <td><%if (FF.getDeanRemarks() != null) {%><%=FF.getDeanRemarks()%><%if (FF.getApprove3()==1){%><br><b><font color = "green"> Approved:</font></b> <%} else if(FF.getRevise3()==1) {%><br><b><font color = "orange">Marked for revision:</font></b><%} else if(FF.getReject3()==1) {%><br><b><font color = "red">Rejected:</font></b><%}%> <%=FF.getDeandatetime()%><%}%> <%if (FF.getDirectorremarks() != null) {%><%=FF.getDirectorremarks()%><%if (FF.getLspoRemarks() !=null){%><b><font color = "green"> Approved:</font></b> <%} else if(FF.getRevise3()==1) {%> <b><font color = "orange">Revised:</font></b><%} else if(FF.getReject3()==1) {%> <b><font color = "red">Rejected:</font></b><%}%> <%=FF.getDirectordatetime()%><%}%></td>
                                </tr>
                                <tr>
