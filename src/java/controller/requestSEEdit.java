 ...
 * @author Dino Alcala
 */
public class requestSEEdit extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            UserDAO.requestEdit(Integer.parseInt(request.getParameter("edit")), request.getParameter("reason"));
            SE SE = UserDAO.retrieveSEBySEID(Integer.parseInt(request.getParameter("edit")));
            SE.setReasonforedit(request.getParameter("reason"));
            ...
            n.setRedirect("/MULTIPLE-approveSEEdit.jsp");
            n.setAttribute(SE.getId());
            UserDAO.AddNotification(n);
            UserDAO.updateStep(11, Integer.parseInt(request.getParameter("edit")));
