                    ...
                    <div class="form-style-5">
                        <fieldset>
                            ...
                            <center><table style = "width:90%" id="attendeestable">
                                    ...
                                    <tr>    
                                        <td><textarea style='border-radius:0px' rows = "1" cols = "45%" name ="attendee0"></textarea></td>
                                        <td><textarea style='border-radius:0px' rows = "1" cols = "45%" name ="email0"></textarea></td>
                                    </tr>
                                </table></center>
                            <br>
                            <center><input type ="button" id="addRowButton" onclick ="addRow()" value="Add Row">
                                <input style="background-color:red; border: red;" type ="button" id="addRowButton" onclick ="deleteRow()" value="Delete Row"/></center>
                        </fieldset>    
                        <br><br><br><br>
