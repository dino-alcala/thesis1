                            ...
                            <div class="col-lg-12">
                                ...
                                <table style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding:0px"><%if (FF.getDeanunitRemarks() != null) {%><%=FF.getDeanunitRemarks()%><%}%></td>
                                    </tr>
                                    <tr>
                                        <td>Assistant Dean for Lasallian Mission/Assistant Unit Head</td>
                                        <td style="padding:0px"><textarea id="remarks1" rows="3" cols="95" style="margin-bottom:-5px;" name="remarks1"><%if (FF.getAssistantdeanRemarks() != null) {%><%=FF.getAssistantdeanRemarks()%><%}%></textarea></td>
                                    </tr>
                                </table>
                                <br/>
