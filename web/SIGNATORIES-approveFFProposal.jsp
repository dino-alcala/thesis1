                                    ...
                                    <div class="card-body">
                                        <table style="width:100%">
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding:0px"><textarea id="remarks1" rows="3" cols="110" style="margin-bottom:-0.5%" name="remarks1"><%if (FF.getADLMRemarks() != null) {%><%=FF.getADLMRemarks()%><%}%></textarea></td>
                                            </tr>                                   
                                        </table>
                                    </div>
                                </div>
