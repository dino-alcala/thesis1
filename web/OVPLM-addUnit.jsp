                                        ...
                                        <form action="addUnit" method="post">
                                            <ul class="form-style-1">
                                                ...
                                                <li>
                                                    ...
                                                    <textarea rows="4" cols="40" name="unitdesc"></textarea>
                                                </li>
