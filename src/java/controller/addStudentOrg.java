...
public class addStudentOrg extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            s.setName(request.getParameter("orgname"));
            s.setCollege(request.getParameter("college"));
            StudentOrgDAO.addStudentOrg(s);
            
            request.setAttribute("successSE", "You have successfully added a new Student Organization!");
