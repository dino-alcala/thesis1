                        ...
                        <div class="col-lg-12">
                            ...
                            <table style="width:100%">
                                <tr>
                                    ...
                                    <td><%if (FF.getChairdirectorRemarks() != null) {%><%=FF.getChairdirectorRemarks()%><%if (FF.getApprove1()==1){%><br><b><font color = "green"> Approved:</font></b> <%} else if(FF.getRevise1()==1) {%><br><b><font color = "orange">Marked for revision:</font></b><%} else if(FF.getReject1()==1) {%><br><b><font color = "red">Rejected:</font></b><%}%> <%=FF.getChairdirectordatetime()%><%}%></td>
                                </tr>
                                <tr>
