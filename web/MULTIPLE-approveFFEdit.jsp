...
<html>
    ...
    <body>
        ...
        <div class="row" id="body-row">
            ...
            <!-- MAIN -->
            <div class="col py-3">
                <form action="approveFFEdit" method="post">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <center>
                                    <button onclick="return window.confirm('Approve Requet for Edit?')" class="btn-success" name="edit" value="<%=FF.getId()%>">Approve Request for Edit</button>
                                </center>
                            </div>
