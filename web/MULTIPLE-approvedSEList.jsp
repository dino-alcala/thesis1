...
<html>
    <head>
        ...
        <title>Approved SE Programs List</title>
    ...
    <body>
        ...
        <div class="row" id="body-row">
            ...
            <!-- MAIN -->
            <div class="col py-3">
                <form action="viewSE8" method="post">

                    <%
                        ArrayList<SE> my = new ArrayList();
                        my = UserDAO.retrieveSEProposalByApprovedOwner(Integer.parseInt(session.getAttribute("userID").toString()));
                    %>
                    <!--- table -->
                    <div class="container-fluid panels">
                        ...
                        <%
                            ...
                            others = UserDAO.retrieveSEProposalByApproved(Integer.parseInt(session.getAttribute("userID").toString()));
                        %>
                        <br><br>
