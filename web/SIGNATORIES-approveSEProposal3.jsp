                            ...
                            <div class="col-lg-12">
                                ...
                                <table style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding:0px"><textarea id="remarks1" rows="3" cols="110" style="margin-bottom:-0.5%" name="remarks1"><%if (SE.getDeanRemarks() != null) {%><%=SE.getDeanRemarks()%><%}%><%if (SE.getVpVcRemarks() != null) {%><%=SE.getVpVcRemarks()%><%}%></textarea></td>
                                    </tr>
                                </table>
                                </div>
                                </div>
