...
public class UserDAO {
    ...
    public ArrayList<Unit> retrieveUnits() {
        ...
        String query = "SELECT * FROM unit WHERE active = 1 GROUP BY unitName ASC";
        PreparedStatement ps = null;
        ResultSet rs = null;
    ...
    public ArrayList<Unit> retrieveUnitsInactive() {
        ...
        String query = "SELECT * FROM unit WHERE active = 0 GROUP BY unitName ASC";
        PreparedStatement ps = null;
        ResultSet rs = null;
        ArrayList<Unit> units = new ArrayList();
    ...
    public ArrayList<Unit> retrieveUnitsNonAcademic() {
        ...
        String query = "SELECT * FROM unit where unitType = 'Non-Academic' and active = 1 GROUP BY unitName ASC";
        PreparedStatement ps = null;
        ResultSet rs = null;
        ArrayList<Unit> units = new ArrayList();
    ...
    public ArrayList<StudentOrg> retrieveStudentOrgs() {
        ...
        String query = "SELECT * FROM studentorgs GROUP BY name ASC";
        PreparedStatement ps = null;
        ResultSet rs = null;
    ...
    public ArrayList<Unit> retrieveUnitsAcademic() {
        ...
        String query = "SELECT * FROM unit where unitType = 'Academic' AND active = 1 GROUP BY unitName ASC";
        PreparedStatement ps = null;
        ResultSet rs = null;
        ArrayList<Unit> units = new ArrayList();
...
>>>>>>> e8211e87e8aa3ec1554b41e00596edb74fbd35b0
    ...
    public void AddSE(SE SE) {
        ...
        try {
            ...
            pstmt.setInt(35, SE.getSustainable());
            pstmt.setString(36, SE.getExplanation());
            ...
            for (int i = 0; i < SE.getExpenses().size(); i++) {
                query = "INSERT INTO seproposal_expenses(item, unitcost, quantity, subtotal, seproposalID, datetime, updatedBy) VALUES(?,?,?,?,?,?,?)";
                ...
                pstmt.setString(7, SE.getExpenses().get(i).getUpdatedBy());
    ...
    public void AddSEComponent(ArrayList<String> component, int seID, int sustainable, String explanation) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;
        ResultSet rs2 = null;
        ...
        try {
            String query = "UPDATE seproposal SET explanation = ?, sustainable = ? WHERE id = ?";

            pstmt = conn.prepareStatement(query);
            pstmt.setString(1, explanation);
            pstmt.setInt(2, sustainable);
            pstmt.setInt(3, seID);
    ...
    public void AddFF(FF FF) {
        ...
        try {
            ...
            for (int i = 0; i < FF.getExpenses().size(); i++) {
                query = "INSERT INTO ffproposal_expenses(item, unitcost, quantity, subtotal, ffproposalID, datetime, updatedBy) VALUES(?,?,?,?,?,?,?)";
                ...
                pstmt.setString(7, FF.getExpenses().get(i).getUpdatedBy());
    ...
    public ArrayList<SE> retrieveSEProposalsForEdit() {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;
        ...
        ResultSet rs2 = null;
        try {
            String query = "SELECT * FROM seproposal WHERE step = 11";
            pstmt = conn.prepareStatement(query);
    ...
    public ArrayList<FF> retrieveFFProposalsForEdit() {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;
        ...
        ResultSet rs2 = null;
        try {
            String query = "SELECT * FROM ffproposal WHERE step = 11";
            pstmt = conn.prepareStatement(query);
            rs2 = pstmt.executeQuery();
    ...
    public ArrayList<SE> retrieveSEProposalByCompleted(int userID) {
        ...
        ResultSet rs2 = null;
        try {
            String query = "SELECT * FROM seproposal WHERE userID != ? AND step = 9";
            pstmt = conn.prepareStatement(query);
            pstmt.setInt(1, userID);
    ...
    public ArrayList<SE> retrieveSEProposalByApproved(int userID) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;
    ...
    public ArrayList<SE> retrieveSEProposalByApprovedOwner(int userID) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;
    ...
    public ArrayList<FF> retrieveFFProposalByApprovedOwner(int userID) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;
    ...
    public ArrayList<FF> retrieveFFProposalByApproved(int userID) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;
    ...
    public ArrayList<FF> retrievePendingFFProposalByUserID(int userID) {
        ...
        ResultSet rs2 = null;
        try {
            String query = "SELECT * FROM ffproposal WHERE userID = ? AND step != 8 AND step != 0 AND step != -1 AND step != 9";
            pstmt = conn.prepareStatement(query);
    ...
    public SE retrieveSEBySEID(int seID) {
        ...
        try {
            ...
            while (rs2.next()) {
                ...
                SE.setReasonforedit(rs2.getString("reasonforedit"));
            }
            ...
            while (rs2.next()) {
                ...
                se.setUpdatedBy(rs2.getString("updatedBy"));
                expenses.add(se);
            }
    ...
    public FF retrieveFFByFFID(int ffID) {
        ...
        try {
            ...
            while (rs2.next()) {
                ...
                FF.setReasonforedit(rs2.getString("reasonforedit"));
            }
            ...
            while (rs2.next()) {
                ...
                ff.setUpdatedBy(rs2.getString("updatedBy"));
                expenses.add(ff);
            }
    ...
    public void requestEdit(int seID, String edit) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;

        try {
            String query = "UPDATE seproposal SET reasonforedit = ? WHERE id = ?";
            pstmt = conn.prepareStatement(query);
    ...
    public void requestEditFF(int ffID, String edit) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;

        try {
            String query = "UPDATE ffproposal SET reasonforedit = ? WHERE id = ?";
            pstmt = conn.prepareStatement(query);
            pstmt.setString(1, edit);
            pstmt.setInt(2, ffID);
    ...
    public void requestReviseSE(int seID) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;

        try {
            String query = "UPDATE seproposal SET isRevise = 1, step = 1, lmc1 = 0, lmc2 = 0, lmc3 = 0, lmc4 = 0, lmc5 = 0, hasVoted1 = 0, hasVoted2 = 0, hasVoted3 = 0, hasVoted4 = 0, hasVoted5 = 0, lmcApprovalCount = 0 WHERE id = ?";
            pstmt = conn.prepareStatement(query);
            pstmt.setInt(1, seID);
    ...
    public void requestReviseFF(int ffID) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;

        try {
            String query = "UPDATE ffproposal SET isRevise = 1, step = 1, lmc1 = 0, lmc2 = 0, lmc3 = 0, lmc4 = 0, lmc5 = 0, hasVoted1 = 0, hasVoted2 = 0, hasVoted3 = 0, hasVoted4 = 0, hasVoted5 = 0, lmcApprovalCount = 0 WHERE id = ?";
            pstmt = conn.prepareStatement(query);
            pstmt.setInt(1, ffID);
    ...
    public boolean hasSentEvaluation(int seID) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;
        ResultSet rs2 = null;
    ...
    public boolean hasSentEvaluationFF(int ffID) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;
        ResultSet rs2 = null;
    ...
    public int countFFImplementedByDate(Date startDate, Date endDate) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;
        ...
        int count = 0;
        try {
            String query = "SELECT count(id) FROM ffproposal WHERE step = 9 AND actualImplementation >= ? AND actualImplementation <= ?";
            pstmt = conn.prepareStatement(query);
    ...
    public int countSEImplementedByDate(Date startDate, Date endDate) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;
        ...
        int count = 0;
        try {
            String query = "SELECT count(id) FROM seproposal WHERE step = 9 AND actualImplementation >= ? AND actualImplementation <= ?";
            pstmt = conn.prepareStatement(query);
    ...
    public int countSEImplementedByClassificationDate(String classification, Date startDate, Date endDate) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;
        ...
        int count = 0;
        try {
            String query = "SELECT count(id) FROM seproposal WHERE step = 9 AND activityClassification = ? AND actualImplementation >= ? AND actualImplementation <= ?";
            pstmt = conn.prepareStatement(query);
    ...
    public ArrayList<SE> retrieveSEImplementedByClassificationDate(String classification, Date startDate, Date endDate) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;
        ...
        ResultSet rs2 = null;
        try {
            String query = "SELECT * FROM seproposal WHERE step = 9 AND activityClassification = ? AND actualImplementation >= ? AND actualImplementation <= ?";
            pstmt = conn.prepareStatement(query);
    ...
    public ArrayList<SE> retrieveALLSEImplementedByDate(Date startDate, Date endDate) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;
        ...
        ResultSet rs2 = null;
        try {
            String query = "SELECT * FROM seproposal WHERE step = 9 AND actualImplementation >= ? AND actualImplementation <= ?";
            pstmt = conn.prepareStatement(query);
    ...
    public int countFFImplementedByClassificationDate(String classification, Date startDate, Date endDate) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;
        ...
        int count = 0;
        try {
            String query = "SELECT count(id) FROM ffproposal WHERE step = 9 AND activityClassification = ? AND actualImplementation >= ? AND actualImplementation <= ?";
            pstmt = conn.prepareStatement(query);
    ...
    public ArrayList<FF> retrieveFFImplementedByClassificationDate(String classification, Date startDate, Date endDate) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;
        ...
        ResultSet rs2 = null;
        try {
            String query = "SELECT * FROM ffproposal WHERE step = 9 AND activityClassification = ? AND actualImplementation >= ? AND actualImplementation <= ?";
            pstmt = conn.prepareStatement(query);
    ...
    public ArrayList<FF> retrieveALLFFImplementedByDate(Date startDate, Date endDate) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;
        ...
        ResultSet rs2 = null;
        try {
            String query = "SELECT * FROM ffproposal WHERE step = 9 AND actualImplementation >= ? AND actualImplementation <= ?";
            pstmt = conn.prepareStatement(query);
    ...
    public int countSEImplementedByUnit(String unit, Date startDate, Date endDate) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;
        ...
        int count = 0;
        try {
            String query = "SELECT count(unit) FROM seproposal WHERE step = 9 AND unit = ? AND actualImplementation >= ? AND actualImplementation <= ? AND studentorg != 1";
            pstmt = conn.prepareStatement(query);
    ...
    public int countSEImplementedByUnitStudentOrg(String unit, Date startDate, Date endDate) {
        ...
        int count = 0;
        try {
            String query = "SELECT count(unit) FROM seproposal WHERE step = 9 AND unit = ? AND actualImplementation >= ? AND actualImplementation <= ?";
            pstmt = conn.prepareStatement(query);
    ...
    public int countSEImplementedByStudentOrg(String studentorg, Date startDate, Date endDate) {
        ...
        int count = 0;
        try {
            String query = "SELECT count(department) FROM seproposal WHERE step = 9 AND department = ? AND actualImplementation >= ? AND actualImplementation <= ?";
            pstmt = conn.prepareStatement(query);

            pstmt.setString(1, studentorg);
            pstmt.setDate(2, startDate);
            pstmt.setDate(3, endDate);
    ...
    public int countSEImplementedByDepartment(String unit, String department, Date startDate, Date endDate) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;
        ...
        int count = 0;
        try {
            String query = "SELECT count(department) FROM seproposal WHERE step = 9 AND department = ? AND actualImplementation >= ? AND actualImplementation <= ? AND unit = ?";
            pstmt = conn.prepareStatement(query);
    ...
    public int countFFImplementedByUnit(String unit, Date startDate, Date endDate) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;
        ...
        int count = 0;
        try {
            String query = "SELECT count(unit) FROM ffproposal WHERE step = 9 AND unit = ? AND actualImplementation >= ? AND actualImplementation <= ? AND studentorg != 1";
            pstmt = conn.prepareStatement(query);
    ...
    public int countFFImplementedByUnitStudentOrg(String unit, Date startDate, Date endDate) {
        ...
        int count = 0;
        try {
            String query = "SELECT count(unit) FROM ffproposal WHERE step = 9 AND unit = ? AND actualImplementation >= ? AND actualImplementation <= ?";
            pstmt = conn.prepareStatement(query);
    ...
    public int countFFImplementedByStudentOrg(String studentorg, Date startDate, Date endDate) {
        ...
        int count = 0;
        try {
            String query = "SELECT count(department) FROM ffproposal WHERE step = 9 AND department = ? AND actualImplementation >= ? AND actualImplementation <= ?";
            pstmt = conn.prepareStatement(query);
    ...
    public int countFFImplementedByDepartment(String unit, String department, Date startDate, Date endDate) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;
        ...
        int count = 0;
        try {
            String query = "SELECT count(department) FROM ffproposal WHERE step = 9 AND department = ? AND actualImplementation >= ? AND actualImplementation <= ? AND unit = ?";
            pstmt = conn.prepareStatement(query);
    ...
    public ArrayList<Community> retrieveProgramsCommunityByDate(Date startDate, Date endDate) {
        ...
        ResultSet rs2 = null;
        try {
            String query = "SELECT c.name, count(c.name) as TOTAL FROM community c JOIN seproposal s ON s.targetCommunity = c.communityID WHERE step = 9 AND actualImplementation >= ? AND actualImplementation <= ? GROUP BY c.name";
            pstmt = conn.prepareStatement(query);
            pstmt.setDate(1, startDate);
            pstmt.setDate(2, endDate);
    ...
    public double getBudgetImplementedByDate(Date startDate, Date endDate) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;
        ...
        double budget = 0;
        try {
            String query = "SELECT SUM(total.totalAmountRequested) as totalRequestedBudget FROM (SELECT totalAmountRequested FROM seproposal WHERE step = 9 AND actualImplementation >= ? AND actualImplementation <= ? AND sourceOfFunds = 'OVPLM' UNION ALL SELECT totalAmount as totalAmountRequested from ffproposal WHERE step = 9 AND actualImplementation >= ? AND datecreated <= ? AND sourceOfFunds = 'OVPLM') as total";
            pstmt = conn.prepareStatement(query);
            pstmt.setDate(1, startDate);
            pstmt.setDate(2, endDate);
    ...
    public int countProgramsCompletedByCommunityID(int communityID, Date startDate, Date endDate) {
        ...
        String query = "SELECT count(s.targetCommunity) as programsCompleted FROM seproposal s JOIN sereport se ON s.ID = se.seproposalID WHERE s.targetCommunity = ? AND step = 9 AND s.actualImplementation >= ? AND s.actualImplementation <= ?";
        PreparedStatement ps = null;
        ResultSet rs = null;
    ...
    public int countProgramsActivityClassificationImplementedByCommunityID(int communityID, String activityClassification, Date startDate, Date endDate) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();

        String query = "SELECT count(s.activityClassification) as programsCompleted FROM seproposal s JOIN sereport se ON s.ID = se.seproposalID WHERE s.targetCommunity = ? AND s.activityClassification = ? AND s.step = 9 AND s.actualImplementation >= ? AND s.actualImplementation <= ?";
        PreparedStatement ps = null;
        ResultSet rs = null;
    ...
    public ArrayList<SE> retrieveSEProposalCompletedByCommunityID(int communityID, Date startDate, Date endDate) {
        ...
        ResultSet rs2 = null;
        try {
            String query = "SELECT s.datecreated, s.programName, s.programHead, s.unit, s.department, s.sourceOfFunds, s.Id, s.activityClassification FROM seproposal s JOIN sereport se ON s.ID = se.seproposalID WHERE s.targetCommunity = ? AND s.step = 9 AND s.actualImplementation >= ? AND s.actualImplementation <= ?";
            pstmt = conn.prepareStatement(query);
    ...
    public int countProgramsUnitImplementedByCommunityID(int communityID, String unit, Date startDate, Date endDate) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();

        String query = "SELECT count(s.unit) as programsCompleted FROM seproposal s JOIN sereport se ON s.ID = se.seproposalID WHERE s.targetCommunity = ? AND s.unit = ? AND s.step = 9 AND s.actualImplementation >= ? AND s.actualImplementation <= ?";
        PreparedStatement ps = null;
        ResultSet rs = null;
    ...
    public int countProgramsUnitAffliatedCompletedByCommunityID(int communityID, Date startDate, Date endDate) {
        ...
        String query = "SELECT count(DISTINCT s.unit) as programsCompleted FROM seproposal s JOIN sereport se ON s.ID = se.seproposalID WHERE s.targetCommunity = ? AND s.step = 9 AND s.actualImplementation >= ? AND s.actualImplementation <= ?";
        PreparedStatement ps = null;
        ResultSet rs = null;
    ...
    public double getImplementedUtilizedBudgetByDate(Date startDate, Date endDate) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;
        ...
        double budget = 0;
        try {
            String query = "SELECT SUM(a.expendedAmount) FROM (SELECT sf.expendedAmount FROM sereport_funds sf JOIN sereport se ON sf.sereportID = se.id JOIN seproposal s ON s.id = se.seproposalID WHERE s.step = 9 AND s.actualImplementation >= ? AND s.actualImplementation <= ? AND s.sourceOfFunds = 'OVPLM' UNION ALL SELECT ff.expendedAmount FROM ffreport_funds ff JOIN ffreport fr ON ff.ffreportID = fr.id JOIN ffproposal f ON f.id = fr.ffproposalID WHERE step = 9 AND f.actualImplementation >= ? AND f.actualImplementation <= ? AND f.sourceOfFunds = 'OVPLM') as a";
            pstmt = conn.prepareStatement(query);
            pstmt.setDate(1, startDate);
            pstmt.setDate(2, endDate);
            pstmt.setDate(3, startDate);
    ...
    public ArrayList<SE> retrieveSEImplementedByUnitClassificationDate(String unit, String classification, Date startDate, Date endDate) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;
        ...
        ResultSet rs2 = null;
        try {
            String query = "SELECT * FROM seproposal WHERE step = 9 AND unit = ? AND activityClassification = ? AND actualImplementation >= ? AND actualImplementation <= ?";
            pstmt = conn.prepareStatement(query);
    ...
    public ArrayList<SE> retrieveALLSEImplementedByUnitDate(String unit, Date startDate, Date endDate) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;
        ...
        ResultSet rs2 = null;
        try {
            String query = "SELECT * FROM seproposal WHERE step = 9 AND unit = ? AND actualImplementation >= ? AND actualImplementation <= ?";
            pstmt = conn.prepareStatement(query);
    ...
    public ArrayList<FF> retrieveFFImplementedByUnitClassificationDate(String unit, String classification, Date startDate, Date endDate) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;
        ...
        ResultSet rs2 = null;
        try {
            String query = "SELECT * FROM ffproposal WHERE step = 9 AND unit = ? AND activityClassification = ? AND actualImplementation >= ? AND actualImplementation <= ?";
            pstmt = conn.prepareStatement(query);
    ...
    public ArrayList<FF> retrieveALLFFImplementedByUnitDate(String unit, Date startDate, Date endDate) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;
        ...
        ResultSet rs2 = null;
        try {
            String query = "SELECT * FROM ffproposal WHERE step = 9 AND unit = ? AND actualImplementation >= ? AND actualImplementation <= ?";
            pstmt = conn.prepareStatement(query);
    ...
    public ArrayList<Community> retrieveProgramsUnitCommunityByDate(String unit, Date startDate, Date endDate) {
        ...
        ResultSet rs2 = null;
        try {
            String query = "SELECT c.name, count(c.name) as TOTAL FROM community c JOIN seproposal s ON s.targetCommunity = c.communityID WHERE step = 9 AND unit = ? AND actualImplementation >= ? AND actualImplementation <= ? GROUP BY c.name";
            pstmt = conn.prepareStatement(query);
            pstmt.setString(1, unit);
            pstmt.setDate(2, startDate);
            pstmt.setDate(3, endDate);
    ...
    public double getBudgetImplementedByUnitDate(String unit, Date startDate, Date endDate) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;
        ...
        double budget = 0;
        try {
            String query = "SELECT SUM(total.totalAmountRequested) as totalRequestedBudget FROM (SELECT totalAmountRequested FROM seproposal WHERE step = 9 AND unit = ? AND actualImplementation >= ? AND actualImplementation <= ? AND sourceOfFunds = 'OVPLM' UNION ALL SELECT totalAmount as totalAmountRequested from ffproposal WHERE step = 9 AND unit = ? AND actualImplementation >= ? AND actualImplementation <= ? AND sourceOfFunds = 'OVPLM') as total";
            pstmt = conn.prepareStatement(query);
            pstmt.setString(1, unit);
            pstmt.setDate(2, startDate);
            pstmt.setDate(3, endDate);
    ...
    public double getImplementedUtilizedBudgetUnitByDate(String unit, Date startDate, Date endDate) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;
        ...
        double budget = 0;
        try {
            String query = "SELECT SUM(a.expendedAmount) FROM (SELECT sf.expendedAmount FROM sereport_funds sf JOIN sereport se ON sf.sereportID = se.id JOIN seproposal s ON s.id = se.seproposalID WHERE s.step = 9 AND s.unit = ? AND s.actualImplementation >= ? AND s.actualImplementation <= ? AND s.sourceOfFunds = 'OVPLM' UNION ALL SELECT ff.expendedAmount FROM ffreport_funds ff JOIN ffreport fr ON ff.ffreportID = fr.id JOIN ffproposal f ON f.id = fr.ffproposalID WHERE f.step = 9 AND f.unit = ? AND f.actualImplementation >= ? AND f.actualImplementation <= ? AND f.sourceOfFunds = 'OVPLM') as a";
            pstmt = conn.prepareStatement(query);
            pstmt.setString(1, unit);
            pstmt.setDate(2, startDate);
            pstmt.setDate(3, endDate);
    ...
    public int countCommunitiesVisited(String unit, Date startDate, Date endDate) {
        ...
        int count = 0;
        try {
            String query = "SELECT count(DISTINCT c.name) as TOTAL FROM community c JOIN seproposal s ON s.targetCommunity = c.communityID WHERE step = 9 AND unit = ? AND actualImplementation >= ? AND actualImplementation <= ?";
            pstmt = conn.prepareStatement(query);
            pstmt.setString(1, unit);
            pstmt.setDate(2, startDate);
            pstmt.setDate(3, endDate);
    ...
    public double getIndividualSEBudgetImplementedByUnitDate(String unit, Date startDate, Date endDate) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;
    ...
    public double getIndividualFFBudgetImplementedByUnitDate(String unit, Date startDate, Date endDate) {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;
    ...
    public int countOVPLMPrograms(Date startDate, Date endDate) {
        ...
        String query = "SELECT count(a.sourceOfFunds) FROM (SELECT sourceOfFunds FROM seproposal WHERE step = 9 AND actualImplementation >= ? AND actualImplementation <= ? UNION ALL SELECT sourceOfFunds from ffproposal WHERE step = 9 AND actualImplementation >= ? AND actualImplementation <= ?) as a WHERE a.sourceOfFunds = 'OVPLM'";
        PreparedStatement ps = null;
        ResultSet rs = null;
    ...
    public int countOtherPrograms(Date startDate, Date endDate) {
        ...
        String query = "SELECT count(a.sourceOfFunds) FROM (SELECT sourceOfFunds FROM seproposal WHERE step = 9 AND actualImplementation >= ? AND actualImplementation <= ? UNION ALL SELECT sourceOfFunds from ffproposal WHERE step = 9 AND actualImplementation >= ? AND actualImplementation <= ?) as a WHERE a.sourceOfFunds = 'Others'";
        PreparedStatement ps = null;
        ResultSet rs = null;
    ...
    public void updateBudgetSE(ArrayList<SEexpenses> expenses) {
        ...
        try {
            ...
            for (int i = 0; i < expenses.size(); i++) {
                query = "INSERT INTO seproposal_expenses(item, unitcost, quantity, subtotal, amountUsed, seproposalID, datetime, updatedBy) VALUES(?,?,?,?,?,?,?,?)";
                ...
                pstmt.setString(8, expenses.get(i).getUpdatedBy());
    ...
    public void updateBudgetFF(ArrayList<FFexpenses> expenses) {
        ...
        try {
            ...
            for (int i = 0; i < expenses.size(); i++) {
                query = "INSERT INTO ffproposal_expenses(item, unitcost, quantity, subtotal, amountUsed, ffproposalID, datetime, updatedBy) VALUES(?,?,?,?,?,?,?,?)";
    ...
    public Measure GetMeasureObject(int id) {
        ...
        try {
            ...
            while (rs2.next()) {
                m.setMeasure(rs2.getString("measure"));
                m.setDescription(rs2.getString("description"));
                m.setNumtarget(rs2.getInt("numtarget"));
                m.setNumtypetarget(rs2.getString("numtypetarget"));
    ...
    public int countTotalProposalByUnit(String unit) {
        ...
        String query = "SELECT count(unit) FROM seproposal WHERE step = 9 AND unit = ?";
        PreparedStatement ps = null;
        ResultSet rs = null;
    ...
    public ArrayList<SE> retrieveALLSEProposal() {
        DBConnectionFactory myFactory = DBConnectionFactory.getInstance();
        Connection conn = myFactory.getConnection();
        PreparedStatement pstmt = null;
    ...
    public double thirdTarget() {
        ...
        try {
            ...
            String query = "SELECT a.type FROM ffproposal f JOIN ffreport ff ON f.id = ff.ffproposalID JOIN ffreport_attendees a ON ff.id = a.ffreportID WHERE f.step = 9 AND a.type IN ('CAP', 'APSP', 'ASF', 'Faculty', 'Admin', 'Directhired', 'Independent', 'External')";
    ...
    public double fourthTarget() {
        ...
        try {
            ...
            percent = ((double) count / (double) 13) * 100;
