...
<html>
    ...
    <body>
        ...
        <div id="sidebar-container">
            ...
            <%
                //sidebar for college deans (signatories)
                if (session.getAttribute("position").toString().contains("Director") && !session.getAttribute("unit").equals("Laguna Campus Lasallian Mission (LCLM)") && !session.getAttribute("unit").equals("Lasallian Pastoral Office (LSPO)") && !session.getAttribute("unit").equals("Center for Social Concern and Action (COSCA)") && !session.getAttribute("position").toString().contains("Social Engagement")) {
            %>
            <ul class="list-group sticky-top sticky-offset">
                <!-- Menu with submenu -->
                <a href="SIGNATORIES-home2.jsp" class="list-group-item list-group-item-action flex-column align-items-start" id="sidebarCategory">
