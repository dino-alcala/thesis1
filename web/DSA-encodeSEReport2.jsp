                    ...
                    <form action="encodeSEReport2" method="post">
                        ...
                        <fieldset>
                            ...
                            <center>
                                ...
                                <button class="button" style="background-color:red" type ="button" id="deleteRowButton" onclick ="deleteRow()" >Delete Row</button>
                            </center>
                            <br>
                        </fieldset>
                        ...
                        <fieldset>
                            ...
                            <center><table style = "width:100%" id="others">
                                    ...
                                    %>
                                    <tr>
                                        <td><textarea id="inputText" rows = "2" cols = "20%" name ="item<%=i%>" readonly><%=expenses.get(i).getItem()%></textarea></td>
                                        <td><textarea id="inputText" rows = "2" cols = "20%" name ="approved<%=i%>" readonly><%=expenses.get(i).getUnitcost() * expenses.get(i).getQuantity()%></textarea></td>
                                        <td><textarea id="inputText" rows = "2" cols = "20%" name ="expended<%=i%>" readonly><%=expenses.get(i).getAmountUsed()%></textarea></td>
                                        <td><textarea id="inputText" rows = "2" cols = "20%" name ="variance<%=i%>" readonly><%=(expenses.get(i).getUnitcost() * expenses.get(i).getQuantity()) - expenses.get(i).getAmountUsed()%></textarea></td>
                                        <td><textarea id="inputText" rows = "2" cols = "20%" name ="reason<%=i%>" required></textarea></td>
                                    </tr>
                                    <%
                                        }
                                    %>
                            ...
                            <br>
                            <center>
                                <button class="button" type ="button" id="addRowButton" onclick ="addRow3()">Add Row</button>
                                <button class="button" style="background-color:red" type ="button" id="deleteRowButton" onclick ="deleteRow3()" >Delete Row</button>
                            </center>
                                <%
                                    }
                                %>
                        ...
                        <br><br>
                        <center><button class="button" type="submit" name="funds" value="<%=SE.getSourceOfFunds()%>">Next</button></center>
                    </form>
                </div>
