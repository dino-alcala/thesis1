<%-- 
    Document   : DSA-home
    Created on : 06 18, 18, 7:14:34 PM
    Author     : Karl Madrid
--%>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-md fixed-top" id="navbar">
            ...
            <a class="navbar-brand" href="#" id="navbar-unit">
                ...
                <span class="menu-collapsed">Dean of Student Affairs</span>
            </a>
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    <li class="nav-item dropdown d-sm-block d-md-none">
                        <a class="nav-link" href="DSA-home.jsp" id="smallerscreenmenu">
                            Home
                        </a>
