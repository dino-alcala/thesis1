                ...
                <div class="form-style-5">
                    <form action="encodeFFReport2" method="post">
                        ...
                        <fieldset>
                            ...
                            <br>
                            <center><button type ="button" class="button" id="addRowButton" onclick ="addRow()" value="Add Row">Add row</button>
                        ...
                        <fieldset>
                            ...
                            <br>
                            <center><button type ="button" class="button" id="addRowButton" onclick ="addRow2()" value="Add Row">Add row</button>
